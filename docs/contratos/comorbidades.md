...
- **Escopo da Sprint 1:** criação de comorbidade com os campos `nome` e `descricao`.
...
{
  "nome": "Hipertensão",
  "descricao": "Registro de hipertensão arterial."
}
```
...
```json
{
  ...
  "status": 404,
  "detail": "Comorbidade não encontrada.",
  "instance": "/comorbidades",
  "timestamp": "2026-08-24T13:00:00-03:00"
}
```
...
```json
{
  ...
  "status": 409,
  "detail": "Já existe uma comorbidade cadastrada com este nome.",
  "instance": "/comorbidades",
  "timestamp": "2026-08-24T13:00:00-03:00"
}
```
